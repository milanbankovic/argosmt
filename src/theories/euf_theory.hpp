...
#ifndef _EUF_THEORY_H
#define _EUF_THEORY_H
...
class euf_theory : public theory {
private:
  ...
  class euf_theory_data : public expression_data {
  private:
    bool _relevant;
    const unsigned & _current_level;
  ...
  public:
    euf_theory_data(const expression e, bool relevant, const unsigned & level)
      :_relevant(relevant),
  ...
  data_extractor<euf_theory_data> _theory_data;
  ...
  bool are_congruent(const expression & x, const expression & y)
  {
    return get_theory_data(x)->get_representative() == 
      get_theory_data(y)->get_representative();
  }
  ...
  euf_theory_data * get_theory_data(const expression & e)
  {
    return _theory_data.get_data(e);
  } 
  
  void set_theory_data(const expression & e, euf_theory_data * data)
  {
